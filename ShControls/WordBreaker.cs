...
namespace ShControls
{
    ...
    ///  - Fire events when a user navigates (either with mouse or keyboard) to beginning or end of a word in the Document.
    ///  - Fire events when a user modifies a word, such as deleting a word, shortening a word, or lengthening a word.
    /// </summary>
